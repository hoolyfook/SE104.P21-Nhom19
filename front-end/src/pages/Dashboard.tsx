export default function Schedule() {
  ...
  const schedule = [
    ...
    { day: "Thứ 7", start: 4, duration: 3, subject: "Tiếng Anh nâng cao", room: "P11" },
  ];

  return (
    <div className="p-6 text-center">
      <h2 className="text-[30px] font-semibold mb-4">📅 Thời Khóa Biểu</h2>
            ...
            <tr key={period.id} className="text-center">
              ...
              {["Thứ 2", "Thứ 3", "Thứ 4", "Thứ 5", "Thứ 6", "Thứ 7"].map((day) => {
                ...
                const isHidden = schedule.some(
                  (item) =>
                    item.day === day &&
                    period.id > item.start &&
                    period.id < item.start + item.duration
                );
                ...
                return (
                  <td
                    ...
                    className={`border p-2 ${
                      subject ? "bg-blue-100 font-semibold" : ""
                    }`}
