    ...
    up: async (queryInterface, Sequelize) => {
        ...
        await queryInterface.bulkInsert('Users', [
            // Admin
            {
                ...
                mk: 'e2e4c71b1cac321b8c1d44b96149c5864ab4a88fa9db5367d682ff00a652cc60', //securepassword
            ...
            // Teacher 1
            {
                ...
                mk: 'e2e4c71b1cac321b8c1d44b96149c5864ab4a88fa9db5367d682ff00a652cc60',
        ...
        for (const malop of classes) {
            for (let i = 0; i < 40; i++) {
                ...
                let newStudent = {
                    ...
                    diaChi: 'Hanoi, Vietnam',
                    email: email,
                    mk: '9514420ce07ad0698e7de77318935e75db9dbbdf2fb64f23e479558efbf83ef8', //studentpassword
